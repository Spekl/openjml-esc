...
(assert (distinct T_java_io_Serializable T_org_jmlspecs_lang_JMLDataGroup T_java_lang_Exception T_java_lang_Cloneable T_java_lang_Object T_java_lang_String T_java_lang_CharSequence T_MaybeAdd T_java_lang_Comparable T_java_lang_RuntimeException))
;OUT: success

(assert (distinct JMLT_java_io_Serializable JMLT_org_jmlspecs_lang_JMLDataGroup JMLT_java_lang_Exception JMLT_java_lang_Cloneable JMLT_java_lang_Object JMLT_java_lang_String JMLT_java_lang_CharSequence JMLT_MaybeAdd JMLT_java_lang_RuntimeException))
;OUT: success
...
(declare-fun ASSERT_13_7_7___4 () Bool)
;OUT: success
...
(declare-fun ASSERT_20_7_7___8 () Bool)
;OUT: success

(declare-fun ASSERT_21_7_7___9 () Bool)
;OUT: success
...
(declare-fun BL_7_AfterLabel_3 () Bool)
;OUT: success

(declare-fun BL_7_AfterLabel_11 () Bool)
;OUT: success
...
(declare-fun BL_7_then_19 () Bool)
;OUT: success

(declare-fun BL_7_else_20 () Bool)
;OUT: success
...
(declare-fun BL_7_throw_27 () Bool)
;OUT: success

(declare-fun BL_7_afterIf_18 () Bool)
;OUT: success

(declare-fun BL_7tryTarget_5 () Bool)
;OUT: success

(declare-fun BL_7noException_7 () Bool)
;OUT: success

(declare-fun BL_7nocatch_8 () Bool)
;OUT: success

(declare-fun BL_7_finally_6 () Bool)
;OUT: success

(declare-fun BL_7_then_29 () Bool)
;OUT: success

(declare-fun BL_7_else_30 () Bool)
;OUT: success

(declare-fun BL_7_afterIf_28 () Bool)
;OUT: success

(declare-fun BL_7finallyNormal_9 () Bool)
;OUT: success

(declare-fun BL_7finallyExit_10 () Bool)
;OUT: success

(declare-fun BL_7_AfterTry_4 () Bool)
;OUT: success
...
(assert (= BL_1758_afterIf_15 (=> (distinct (select java.lang.Object_objectState_1211 _JML__tmp1) NULL) (=> (distinct (select java.lang.Object_privateState_1345 _JML__tmp1) NULL) (=> (distinct (select java.lang.Object_theString_6988 _JML__tmp1) NULL) (and BL_7_then_19 BL_7_else_20))))))
;OUT: success

(assert (= BL_7_then_19 (=> (= _JML___exceptionCall_7_7___5 NULL) BL_7_afterIf_18)))
;OUT: success

(assert (= BL_7_else_20 (=> (not (= _JML___exceptionCall_7_7___5 NULL)) (=> (= _JML___exception_7_7___6 _JML___exceptionCall_7_7___5) (=> (= _JML___termination_7_7___7 (- 7)) (=> false (and BL_1758_then_22 BL_1758_else_23)))))))
;OUT: success

(assert (= BL_1758_then_22 (=> _JML__tmp3 (and BL_7_then_25 BL_7_else_26))))
;OUT: success

(assert (= BL_7_then_25 (=> true (=> false BL_7_afterIf_24))))
;OUT: success

(assert (= BL_7_else_26 (=> (not true) BL_7_afterIf_24)))
;OUT: success

(assert (= BL_7_afterIf_24 (=> (or false (and (distinct _JML___exception_7_7___6 NULL) (javaSubType (javaTypeOf _JML___exception_7_7___6) T_java_lang_RuntimeException))) BL_1758_afterIf_21)))
;OUT: success

(assert (= BL_1758_else_23 (=> (not _JML__tmp3) BL_1758_afterIf_21)))
;OUT: success

(assert (= BL_1758_afterIf_21 BL_7_throw_27))
;OUT: success

(assert (= BL_7_throw_27 BL_7tryTarget_5))
;OUT: success

(assert (= BL_7_afterIf_18 (=> (= _JML___exception_7_7___6 _JML___exception_7_7___2) (=> (= _JML___termination_7_7___7 _JML___termination_7_7___3) BL_7tryTarget_5))))
;OUT: success

(assert (= BL_7tryTarget_5 (and BL_7noException_7 BL_7nocatch_8)))
;OUT: success

(assert (= BL_7noException_7 (=> (= _JML___exception_7_7___6 NULL) BL_7_finally_6)))
;OUT: success

(assert (= BL_7nocatch_8 (=> (distinct _JML___exception_7_7___6 NULL) BL_7_finally_6)))
;OUT: success

(assert (= BL_7_finally_6 (and BL_7_then_29 BL_7_else_30)))
;OUT: success

(assert (= BL_7_then_29 (=> (= _JML___exception_7_7___6 NULL) BL_7_afterIf_28)))
;OUT: success

(assert (= BL_7_else_30 (=> (not (= _JML___exception_7_7___6 NULL)) (=> (= ASSERT_20_7_7___8 (and (distinct _JML___exception_7_7___6 NULL) (javaSubType (javaTypeOf _JML___exception_7_7___6) T_java_lang_RuntimeException))) (and ASSERT_20_7_7___8 (=> ASSERT_20_7_7___8 BL_7_afterIf_28))))))
;OUT: success

(assert (= BL_7_afterIf_28 (=> (= ASSERT_21_7_7___9 (distinct __JML_AssumeCheck_ 2)) (and ASSERT_21_7_7___9 (=> ASSERT_21_7_7___9 (and BL_7finallyNormal_9 BL_7finallyExit_10))))))
;OUT: success

(assert (= BL_7finallyNormal_9 (=> (= _JML___termination_7_7___7 0) BL_7_AfterTry_4)))
;OUT: success

(assert (= BL_7finallyExit_10 (=> (distinct _JML___termination_7_7___7 0) BL_7_AfterTry_4)))
;OUT: success

(assert (= BL_7_AfterTry_4 true))
;OUT: success
